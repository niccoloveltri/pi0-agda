...
%%   \frametitle{\Pio\ syntax: programs}
  ...
  \begin{array}{lr}%{|cc|}
    ...
    \\[.2cm] % \infer{f \otimes g : A \otimes B \lr C \otimes D}{f : A \lr C & g : B \lr D} \\
...
%    \item Denotationally, \Pio\ programs are partial invertible functions.
  \end{itemize}
...
%%   \item Let $\Inv \D$ be the subcategory of $\D$
...
%%       
%%       $\traceD$ respects weak bisimilarity and satisfies the trace
