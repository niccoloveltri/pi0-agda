...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Homsets in $\Dapprox$ are written: $A \to_{\Dapprox} B$   
      ...
      \pause
      \vspace{\fill}
    \item We are quotienting the homsets of $\D$, not the objects!
...
\begin{frame}
  ...
  \item We have extended the work of [Carette and Sabry'16] to a
    ...
    \item This required a change of semantic domains, taking into
    ...
    \item The (unquotiented) delay monad can also be used for
